...
//       if (ProjectApp.auth.currentUser != null) {
...
//   //   ProjectApp.auth.currentUser();

//   //   if (ProjectApp.auth.currentUser() != null) {
//   //     saveUserInfoToFireStore(ProjectApp.user).then((value) {
//   //       Navigator.pop(context);
...
//     String id = pref.getString(ProjectApp.userUID);
...
//       "url": userImageUrl,
//       // ProjectApp.userCartList: ["garbageValue"],
//     });
//     await ProjectApp.sharedPreferences
//         .setString(ProjectApp.userkitchen, _tiffintextEditingController.text);
//     await ProjectApp.sharedPreferences
//         .setString(ProjectApp.userphone, _phonetextEditingController.text);
//     // await ProjectApp.sharedPreferences.setString(
//     //     ProjectApp.userlunchtime, _lunchtimetextEditingController.text);
//     await ProjectApp.sharedPreferences.setString(
//         ProjectApp.userlunchprice, _lunchpricetextEditingController.text);
//     // await ProjectApp.sharedPreferences.setString(
//     //     ProjectApp.userdinnertime, _dinnertimetextEditingController.text);
//     await ProjectApp.sharedPreferences.setString(
//         ProjectApp.userdinnerprice, _dinnerpricetextEditingController.text);
//     await ProjectApp.sharedPreferences
//         .setString(ProjectApp.userAvatarUrl, userImageUrl);
//   }
// }
